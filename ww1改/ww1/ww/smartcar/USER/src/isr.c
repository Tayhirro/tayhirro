...
#include "steer.h"
#include "motor.h"
uint16 right_speed_in ;
uint16 left_speed_in ;
...
{   //right_speed_in =ctimer_count_read(CTIM3_P04);
	 //left_speed_in =ctimer_count_read(CTIM0_P34);
//	 right_speed_in =ctimer_count_read(CTIM3_P04);
//	 left_speed_in =ctimer_count_read(CTIM0_P34);
//	 toipid_speed_left->input_val= (int)left_speed_in;

...
float Motor_1PID_control(float target,float cur){
    ...
    Motor_1PID.ut=Motor_1PID.Kp_output_val+Motor_1PID.Ki_output_val+Motor_1PID.Kd_output_val+42;//1600偏置14 电机1800偏置42
...
float Motor_2PID_control(float target,float cur){
   ...
   // if(abs((int)target - (int)Motor_2preTarget) > 30){
    ...
    Motor_2PID.output_val=Motor_2PID.boost*(Motor_2PID.ut+target);
